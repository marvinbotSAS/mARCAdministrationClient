...
this.tasksjTable.setShowVerticalLines(true);
    ...
    private void initComponents() {
        ...
        jPanel29Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel29Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TableContentjSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 911, Short.MAX_VALUE))
        );
   ...
   /*     if ( this.CurrentServer == null )
    ...
    private void ContextsStackContentjTableMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ContextsStackContentjTableMouseReleased
        ...
        if ( this.ContextsStackContentjTable.getSelectedRows() == null || this.ContextsStackContentjTable.getSelectedRows().length == 0) 
        {
            this.CurrentSession.shownContextIndex = -1;
            CurrentContext = null;
            return;
        }
        if (evt.getButton() == java.awt.event.MouseEvent.BUTTON1) 
